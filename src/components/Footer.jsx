          ...
          <Container.Inner>
            <div className="flex flex-col items-center justify-between gap-8 sm:flex-row">
              <div className="hidden gap-6 text-sm font-medium text-zinc-800 dark:text-zinc-200 md:flex">
                <NavLink href="https://github.com/Sarf1234">GitHub</NavLink>
                <NavLink href="https://www.linkedin.com/in/sarf-raj-shekh-20812b198/">
                  LinkedIn
                </NavLink>
                <NavLink href="mailto:sarfarajshekh69@gmail.com">Mail</NavLink>
              </div>
              ...
              <p className="font-poppins text-sm tracking-wider text-zinc-400 dark:text-zinc-500">
                &copy; {new Date().getFullYear()} Sarf Raj Shekh. All rights
                reserved.
              </p>
            </div>
          </Container.Inner>
